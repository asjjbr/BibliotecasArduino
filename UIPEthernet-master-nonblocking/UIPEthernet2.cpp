/*
 UIPEthernet2.cpp - Arduino implementation of a uIP wrapper class.
...
memhandle UIPEthernetClass2::in_packet(NOBLOCK);
memhandle UIPEthernetClass2::uip_packet(NOBLOCK);
uint8_t UIPEthernetClass2::uip_hdrlen(0);
uint8_t UIPEthernetClass2::packetstate(0);

unsigned long UIPEthernetClass2::periodic_timer;

IPAddress UIPEthernetClass2::_dnsServerAddress;
#if UIP_UDP
  DhcpClass* UIPEthernetClass2::_dhcp(NULL);
...
UIPEthernetClass2::UIPEthernetClass2()
{
}

#if UIP_UDP
int
UIPEthernetClass2::begin(const uint8_t* mac)
{
...
void
UIPEthernetClass2::begin(const uint8_t* mac, IPAddress ip)
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
void
UIPEthernetClass2::begin(const uint8_t* mac, IPAddress ip, IPAddress dns)
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
void
UIPEthernetClass2::begin(const uint8_t* mac, IPAddress ip, IPAddress dns, IPAddress gateway)
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
void
UIPEthernetClass2::begin(const uint8_t* mac, IPAddress ip, IPAddress dns, IPAddress gateway, IPAddress subnet)
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
int UIPEthernetClass2::maintain(){
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
IPAddress UIPEthernetClass2::localIP()
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
IPAddress UIPEthernetClass2::subnetMask()
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
IPAddress UIPEthernetClass2::gatewayIP()
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
...
IPAddress UIPEthernetClass2::dnsServerIP()
{
  #if ACTLOGLEVEL>=LOG_DEBUG_V3
