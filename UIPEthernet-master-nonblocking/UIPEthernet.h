/*
 UIPEthernet2.h - Arduino implementation of a nonblocking uIP wrapper class.
...
#ifndef UIPETHERNET2_H
#define UIPETHERNET2_H
...
extern UIPEthernetClass2 UIPEthernet2;
